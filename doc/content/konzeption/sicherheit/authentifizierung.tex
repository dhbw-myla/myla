...
Dies bedeutet, dass ein angemeldet Benutzer nur die Ergebnisse seiner eigenen Umfragen sehen kann, nicht aber die Ergebnisse von Umfragen anderer Benutzer.
...
Das geheime Passwort ist lediglich dem jeweiligen Nutzer bekannt, sodass dieser sich damit authentisieren kann.
...
Es handelt sich dabei um eine deterministische Einwegfunktion, d.\,h., wenn derselbe Text, also hier dasselbe Passwort, in eine solche Funktion eingegeben wird, resultiert jedes Mal auch derselbe Hashwert.
...
Sollte ein Nutzer sein Passwort vergessen, kann diese von Administratoren zurückgesetzt werden.
