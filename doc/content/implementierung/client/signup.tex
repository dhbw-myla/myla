...
Hierfür wählt der Benutzer wie in \abb \myRefGeneral{fig:SignupImplement} dargestellt das Formfeld mit seinem Benutzernamen wie z.B. \emph{\texttt{Sascha}}, den Registerkey, der vom Administrator der Software eingetragen wurde. Dieser könnte \emph{\texttt{DemoKey}} sein.
