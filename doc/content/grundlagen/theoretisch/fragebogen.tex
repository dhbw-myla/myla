...
Schon im Anschreiben spielt der zeitliche Faktor eine sehr wichtige Rolle. % das ist ja lustig
...
Besitzen die Fragen als Ziel, dass wertvolle Informationen gesammelt werden. \textbf{TODO ERIK} % TODO: Wie gehts weiter?
Die Standards für Evaluationen beschreiben den Sachverhalt weiter und spiegeln wieder, dass eine durchdachte Fragestellung ebenso wichtig ist. %TODO: Welche standards?
...
Trotzdem wird es Antworten der Befragten geben, welche die Essensauswahl in einer Kantine bewerten. %TODO QUELLE

Fragen können in offene und geschlossene Fragestellungen eingeteilt werden. %TODO ist das ni doppelt?
...
%  Intervall-, Ratio-, verbalisierte und endpunktbenannte Skalen einteilen %2014 Fragebogen S71.
...
Im Gegensatz dazu verschwimmen die Grenzen bei einer zu breiten Skala. % Beispiel
...
In der Umfragepraxis haben sich aus diesem Hintergrund numerische (endpunktbenannte) Likert-Skalen bewährt.\autocite[Vgl.][]{Likert} %https://de.statista.com/statistik/lexikon/definition/82/likert_skala/ 
...
Des Weiteren ist die Beantwortung von offenen Fragen zeitaufwändiger als die Beantwortung von geschlossenen Fragen. %TODO: auch das Auswerten dauert viel länger!!! -S
...
Diese helfen dem Befragten, bessere Antworten zu finden und führen zum Thema hin.\autocite[Vgl.][S. 35]{2009Fragebogen}%2009_BookEvalOnline 35
