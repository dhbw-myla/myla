...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{img/konzeption/client/umfrage_erstellen_multiple_choice}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{img/konzeption/client/umfrage_erstellen_rating}
	\captionsetup{justification=centering, format=plain}
...
\begin{sidewaysfigure}[ht]
	...
	\caption[\acs{ER-Modell}]{\acs{ER-Modell} \quelle Eigene Darstellung}
	\label{fig:er-model}
\end{sidewaysfigure}
