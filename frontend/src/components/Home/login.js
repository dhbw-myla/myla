...
class Login extends Component {
   ...
   render() {
      const { user, signUp, isLoggedIn, isLoading, isPasswordChangeRequired } = this.state;
      ...
      if (signUp) {
         ...
         return (
            <MDBRow>
               ...
               <MDBCol md="12">
                  <MDBInput label="Password" type="password" name="password" onChange={(e) => this.handleOnChange(e)} value={password} />
               </MDBCol>
               {this.buttonsLogin()}
            </MDBRow>
         );
