...
class Login extends Component {
	...
	buttonsLogin = () => {
		return (
			<div>
				<button id="username" type="button" className="btn twoButtons pressButton" onClick={this.handleLogin}>
					Login
				</button>
				<button type="button" className="btn twoButtons pressButton" onClick={this.handleSignup}>
					Sign Up
				</button>
			</div>
		);
	...
	render() {
		const { user, signUp, isLoggedIn, isLoading, activePassword, activeUserName } = this.state;
